                ...
                <Grid container spacing={6} sx={{ marginTop: 0, }}>
                    <Grid item xs={12} md={4}>
                        <div className="row">
                            ...
                            <img src={'/static/images/fellows-and-awardees/Leopold-Flohe.jpg'} alt='Leopold Flohe' />
                            </div>
                        </div>
                    </Grid>
                    <Grid item xs={12} md={8}>
                        ...
                        <p><Link href='sfrri-awards-&-fellowships'>Back to SFRRI Fellowships & Awards</Link></p>
                    </Grid>
                </Grid>
            </Paper>
        </main>
